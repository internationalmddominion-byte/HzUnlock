...
HzUnlock v1.0 🚀
One-click fix for the 240Hz→165Hz bug on Windows 11 laptops
...
Right-click HzUnlock_v1.0.exe → Run as Administrator
Click the Unlock 240Hz button
Done! Go to Display Settings → Advanced Display → 240Hz will be available
⚠️ Important Notes
